    ...
    return (
        <div className="bg-slate-900 p-8 rounded-[32px] text-white overflow-hidden relative group">
            ...
            <div className="flex items-center justify-between mb-8 relative z-10">
                ...
                <button className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-white transition-colors">Upgrade</button>
            </div>
            <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-2">
                    ...
                    <div className="w-full bg-white/10 h-2 rounded-full overflow-hidden">
                        <div className={`h-full rounded-full transition-all duration-1000 ${usage > 90 ? 'bg-rose-500' : 'bg-indigo-500'}`} style={{ width: `${usage}%` }}></div>
                    </div>
                </div>
