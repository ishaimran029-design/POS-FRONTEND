...
export const AppSidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      {isSuper ? <SuperAdminSidebar collapsed={collapsed} /> : <Sidebar collapsed={collapsed} />}
      ...
      {isMobileOpen && (
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          <div className="fixed left-0 top-0 h-full w-[260px] bg-[#262255] z-[70] shadow-2xl animate-in slide-in-from-left duration-300">
            {isSuper ? <SuperAdminSidebar collapsed={false} /> : <Sidebar collapsed={false} />}
          </div>
        </div>
      )}
    </>
