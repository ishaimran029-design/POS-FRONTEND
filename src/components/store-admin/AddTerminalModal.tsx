...
export default function AddTerminalModal({ isOpen, onClose, onSuccess }: AddTerminalModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm animate-fade-in" onClick={handleClose} />
      <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl relative z-10 overflow-hidden">
        <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-slate-900 tracking-tight">Add New Terminal</h2>
              <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Register this device</p>
            </div>
          </div>
        ...
        <div className="p-6">
          {step === 'loading' && (
            <div className="py-12 flex flex-col items-center gap-4">
              ...
              <p className="text-sm font-bold text-slate-600">Reading device fingerprint...</p>
            </div>
          )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 outline-none font-medium"
                  required
                />
              </div>
          ...
          {step === 'success' && (
            <div className="py-8 text-center">
              ...
              <p className="text-slate-600 font-medium">
                Successfully registered as <span className="font-black text-indigo-600">{terminalName || 'Terminal'}</span>
              </p>
              <button
                onClick={handleClose}
