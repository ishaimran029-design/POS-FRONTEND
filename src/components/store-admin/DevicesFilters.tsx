        ...
        <div className="flex flex-col gap-8 bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300">
            <div className="flex flex-col sm:flex-row gap-8 items-start sm:items-center">
                <div className="flex items-center gap-4">
                    <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[2px]">Terminal View:</span>
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${
                                viewFilter === "all"
                                    ...
                                    : "text-slate-400 hover:text-indigo-900 hover:bg-white"
                            }`}
                        >
                ...
                <div className="flex items-center gap-4">
                    <span className="text-[10px] font-medium text-slate-400 uppercase tracking-[2px]">Connectivity:</span>
                    <div className="flex p-1.5 bg-slate-50 border border-slate-100 rounded-2xl">
                        <button
            ...
            <div className="relative group">
                ...
                <input
                    ...
                    className="w-full pl-12 pr-6 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:bg-white focus:border-indigo-600/30 focus:ring-4 focus:ring-indigo-600/5 outline-none transition-all placeholder:text-slate-300 font-medium text-[10px] uppercase tracking-widest text-slate-600 shadow-sm"
                />
            </div>
        </div>
    )
