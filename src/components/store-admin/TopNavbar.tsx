...
export default function TopNavbar({ onMenuClick }: TopNavbarProps) {
    return (
        <header className="h-20 bg-white border-b border-slate-200 sticky top-0 z-40 px-4 sm:px-8 flex items-center justify-between shadow-sm shadow-slate-100/50">
            ...
            <div className="flex items-center gap-4 sm:gap-8">
                ...
                <div className="flex items-center gap-2 text-[10px] sm:text-xs font-black text-slate-400 tracking-widest uppercase truncate max-w-[120px] sm:max-w-none">
                    ...
                    <span className="text-slate-900 border-b-2 border-[#2563EB] pb-0.5">Dashboard</span>
                </div>
                <div className="relative hidden md:block group">
                    ...
                    <input
                        ...
                        className="w-80 pl-12 pr-4 py-2.5 bg-slate-50 border border-transparent rounded-2xl text-sm focus:bg-white focus:border-[#2563EB]/10 focus:ring-4 focus:ring-[#2563EB]/5 transition-all placeholder:text-slate-400 font-bold"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3 pl-2">
                    <div className="text-right hidden sm:block">
                        <p className="text-[10px] font-black text-slate-900 uppercase tracking-tighter">MAIN BRANCH</p>
                        <div className="flex items-center justify-end gap-1.5 mt-0.5">
                            <span className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse shadow-sm shadow-emerald-200"></span>
                            <p className="text-[10px] text-emerald-600 font-black tracking-widest uppercase">ONLINE</p>
                        </div>
                    </div>
