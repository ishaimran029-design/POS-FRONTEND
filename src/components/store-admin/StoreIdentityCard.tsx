const StoreIdentityCard = ({ data, isLoading }: { data: any; isLoading: boolean }) => {
    if (isLoading) return <div className="h-64 bg-white rounded-[32px] animate-pulse" />;
        ...
        <div className="bg-white p-8 rounded-[32px] shadow-sm border border-slate-100 space-y-8 animate-fade-in hover:shadow-md transition-all duration-300">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <textarea 
                        rows={3}
                        defaultValue={data?.address || "Plot 42-C, 4th Lane, DHA Phase 6, Karachi, Pakistan"}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <select 
                                defaultValue={data?.currency || "INR – Indian Rupee"}
                                className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-600 focus:bg-white focus:border-blue-100 outline-none transition-all appearance-none cursor-pointer"
                            >
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <select 
                                defaultValue={data?.timezone || "Asia/Kolkata (IST)"}
                                className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-600 focus:bg-white focus:border-blue-100 outline-none transition-all appearance-none cursor-pointer"
                            >
